                                        ...
                                        <tbody>
                                            @if ($order->type == 'Embroidery')
                                                <tr>
                                                    <td>
                                                        <table
                                                            style="background:url({{ asset('asset/images/header_aenderung_stickprogramm.jpg') }}); background-size:cover; width:800px; height:300px;">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <table
                                            ...
                                            @if ($order->type == 'Vector')
                                                <tr>
                                                    <td>
                                                        <table
                                                            style="background:url({{ asset('asset/images/header_aenderung_vektordatei.jpg') }}); background-size:cover; width:800px; height:300px;">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <table
                                                ...
                                                <td>
                                                    <table style="width: 600px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="content_font_left">Delivery type</td>
                                                            ...
                                                            @endif
                                                            <tr>
                                                                <td class="content_font_left">Change request</td>
                                                                <td class="content_font_right">
                                                                    {{ $text }}</td>
                                                            </tr>
                                                            ...
                                                            @if ($order->type == 'Embroidery')
                                                                <tr>
                                                                    <td class="content_font_left">Yarn information</td>
                                                                    <td class="content_font_right">
                                                                        {{ $em_parameter->parameter1 }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="content_font_left">Need embroidery files
                                                                    </td>
                                                                    <td class="content_font_right">
                                                            ...
                                                            @elseif($order->type == 'Vector')
                                                                <tr>
                                                                    <td class="content_font_left">Required vector files
                                                                    </td>
                                                                    <td class="content_font_right">
                                                                        {{ $ve_parameter->parameter8 }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="content_font_left">Required image files
                                                                    </td>
                                                                    <td class="content_font_right">
