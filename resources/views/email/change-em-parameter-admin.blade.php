                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="header_font">
                                                    Im Stickdatei-Portal wurde soeben eine Änderung der
                                                    ...
                                                    <table style="width: 600px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter1 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Benötige Stickdateien</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter2 }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Schneideoptionen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter3 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Besondere Schneideoptionen
                                                                </td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter4 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Nadelanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter5 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Standardanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter6 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Besondere
                                                                    Standardanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_new->parameter7 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 30px;"></td>
                                                            </tr>
                                                    ...
                                                    <table style="width: 600px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="content_font_left">Garninformationen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter1 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Benötige Stickdateien</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter2 }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Schneideoptionen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter3 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Besondere Schneideoptionen
                                                                </td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter4 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Nadelanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter5 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Standardanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter6 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="content_font_left">Besondere
                                                                    Standardanweisungen</td>
                                                                <td class="content_font_right">
                                                                    {{ $parameter_old->parameter7 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 30px;"></td>
                                                            </tr>
