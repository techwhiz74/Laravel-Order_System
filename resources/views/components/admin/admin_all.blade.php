    ...
    <div>
        <div style="margin-top: 40px;">
            ...
            <div style="font-size:13px;">
                <div class="dropdown" style="display: flex; justify-content:space-between; margin-bottom:5px;">
                    <div class="controlGroup1">
                        ...
                        <div class="DatePickerWrapperStart">
                            ...
                            <input type="text" class="datepicker" id="adminTableDatepickerInputStart">
                    ...
                    <div style="display: flex; align-items:flex-end">
                        ...
                        <div class="tableColumn dropdown" style="margin-left: 10px;">
                            ...
                            <div class="dropdown-menu megamenu" role="menu"
                                ...
                                <label>
                                    <input type="checkbox" id="checkbox_admin_order_type" class="option-input checkbox"
                                        checked />
                                    {{ __('home.order_type') }}
                                </label><br>
                                <label>
