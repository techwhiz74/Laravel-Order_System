<section class="em_freelancer_red_section">

    <div class="pagetitle">
        <h1 style="margin-left: 0 !important">{{ __('home.dashboard_complete_order') }}</h1>
        <p></p>
    </div>
    <div>
        <div style="margin-top: 40px;">
            <button id="em_freelancer_red_table_reload_button" style="display: none"></button>
            <div class="responsive-table">
                <table id="em_freelancer_red_table" class="table table-striped" style="width:100%; font-size:13px;">
                    <thead>
                        <tr>
...
<script>
    ...
    $(function() {
        em_freelancer_red_table = $('#em_freelancer_red_table').DataTable({
            ...
            ajax: {
                url: "{{ __('routes.embroidery-freelancer-red') }}",
                type: "get",
            },
            order: [
                [2, 'desc']
        ...
        $('#em_freelancer_red_table_reload_button').click(function() {
            em_freelancer_red_table.ajax.reload();
        })
    });
</script>
