                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="freelancer_change_div">
                                        <div id="em_green_job">
                                            ...
                                            <div>
                                                <button onclick="EmbroideryStartChange()" class="job_button">START
                                                    CHANGE</button>
                                            </div>
                                        </div>
                                                ...
                                                <div id="em_change_upload_div">
                                                    <form action="" id="embroidery_uplaod_form"
                                                        ...
                                                        <input type="hidden" name="embroidery_request_id"
                                                            value="" />
                                                        <input type="hidden" name="embroidery_time"
                                                            value="" />
                                                        <div style="display: flex; overflow-y:auto;">
                                                            <div id="embroidery_fileupload" action=""
