    <div class="modal fade" id="free_vector_payment_archive" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content" style="background-color: rgb(244, 244, 244)">
                ...
                <div style="font-size: 13px; font-family:'Inter'; padding:20px 10vw">
                    <div class="responsive-table">
                        <button id="ve_freelancer_payment_archive_table_reload_button" style="display: none"></button>
                        <table id="ve_freelancer_payment_archive_table" class="table table-striped">
                            <thead>
                                <tr>
