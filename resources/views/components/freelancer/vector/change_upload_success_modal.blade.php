<div class="modal fade" id="ve_upload_success_popup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row" style="text-align:center;">
                    <div>
                        <button type="button" onclick="VectorEndChange()"
