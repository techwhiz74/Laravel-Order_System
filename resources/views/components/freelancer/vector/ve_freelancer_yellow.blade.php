<section class="page_section">
    ...
    <div>
        <div style="margin-top: 40px;">
            <button id="ve_freelancer_yellow_table_reload_button" style="display: none"></button>
            <div class="responsive-table">
                <table id="ve_freelancer_yellow_table" class="table table-striped">
                    <thead>
                        <tr>
...
<script>
    ...
    var ve_freelancer_yellow_table;

    $(function() {
        ve_freelancer_yellow_table = $('#ve_freelancer_yellow_table').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
        ...
        $('#ve_freelancer_yellow_table_reload_button').click(function() {
