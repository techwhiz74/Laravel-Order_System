<section class="ve_freelancer_all_section">
...
<script>
    ...
    var ve_freelancer_all_table;

    $(function() {
        ve_freelancer_all_table = $('#ve_freelancer_all_table').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
            ...
            ajax: {
                url: "{{ __('routes.vector-freelancer-all') }}",
                type: "get",
            },
            order: [
                [2, 'desc']
        ...
        $('#ve_freelancer_all_table_reload_button').click(function() {
