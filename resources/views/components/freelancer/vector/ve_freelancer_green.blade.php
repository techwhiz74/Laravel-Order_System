<section class="ve_freelancer_green_section">
    ...
    <div>
        <div style="margin-top: 40px;">
            <button id="ve_freelancer_green_table_reload_button" style="display: none"></button>
            <div class="responsive-table">
                <table id="ve_freelancer_green_table" class="table table-striped" style="width:100%; font-size:13px;">
                    <thead>
                        <tr>
...
<script>
    ...
    var ve_freelancer_green_table;

    $(function() {
        ve_freelancer_green_table = $('#ve_freelancer_green_table').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: false,
            ...
            ajax: {
                url: "{{ __('routes.vector-freelancer-green') }}",
                type: "get",
            },
            order: [
                [2, 'desc']
        ...
        $('#ve_freelancer_green_table_reload_button').click(function() {
