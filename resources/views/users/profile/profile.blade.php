                                                        ...
                                                        <div class="employee-top d-flex justify-content-between">
                                                            ...
                                                            <div class=" submit_btn">
                                                                <a href="#invite-employee" data-bs-toggle="modal"
                                                                    style="background: #c4ae79 !important; color: #fff !important; border: 0; border-radius: 0; font-size: 16px; padding: 10px 15px;"
                                                                    class="btn">Invite Employees </a>
                                                            </div>
                                                        </div>
                                                        <div class="employee-list">
                                                            <table id="list-employees" class="table table-striped"
                                                                style="width:100%">
                                                                <thead>
                                                                    <tr>
                                                                        <th>S.no</th>
